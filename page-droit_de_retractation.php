<?php get_header(); ?>
  ...
  <div class="container">
    ...
    <div class="pjustifylastlineleft">
      ...
      <p>Le remboursement n’inclut pas les frais de livraison initiaux supplémentaires dus à votre choix exprès d’un autre mode de livraison que la livraison standard et moins coûteuse proposé par Ergop. </p>
      <p>Conformément à l’article VI.53 du Code de Droit Economique, les biens vendus sur le site https://ergop.emu.isfsc.be qui sont confectionnés selon les spécifications personnalisées du consommateur (création sur mesure), ce dernier ne dispose pas de droit de renoncer à l’achat (droit de rétractation), de droit de retour ou de droit d’échange des produits.</p>
